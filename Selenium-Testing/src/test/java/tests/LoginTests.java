...
public class LoginTests extends BaseTest {
    ...
    public void testSuccessfulLogin(String user, String password){
        ...
        LoginPage loginPage = homePage.clickFormAuthentication("Form Authentication");
        loginPage.setUsername(user);
        Reporter.log("Enter username: " + user,true);
        ...
        //Report duration
        Reporter.log("Test duration: " + getDurationInMillisFrom("testSuccessfulLogin") + " ms",true);
